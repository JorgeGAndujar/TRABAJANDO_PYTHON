...
class Ventana(QMainWindow):
    ...
    def personalizarVentana(self):
        ...
        self.setWindowTitle("VENTANA SELECCION FUTBOL") #Título para la ventana
    ...
    def personalizarComponentes(self):
        ...
        self.tblMostrar.setHorizontalHeaderLabels(["ID","NOMBRE","APELLIDOS","EDAD","ROL"]) # cabecera
    ...
    def cargarDatosTabla(self):
        ...
        for i,objeto in enumerate(seleccionfutbol_lo):
            ...
            self.tblMostrar.setItem(i, 4, QTableWidgetItem(objeto.__class__.__name__))
