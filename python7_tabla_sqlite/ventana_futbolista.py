...
from herencia_seleccionfutbol import Futbolista
...
class Ventana(QMainWindow):
    ...
    def personalizarVentana(self):
        ...
        self.setWindowTitle("FUTBOLISTA") #Título para la ventana
    ...
    def personalizarComponentes(self):
        ...
        self.tblMostrar.setColumnCount(6) # columnas
        self.tblMostrar.setRowCount(0) # filas
        self.tblMostrar.setHorizontalHeaderLabels(["ID","NOMBRE","APELLIDOS","EDAD","DORSAL","DEMARCACION"]) # cabecera
