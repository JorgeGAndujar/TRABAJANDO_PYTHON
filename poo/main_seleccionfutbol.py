...
def menu():
    while True:
          ...
          print("(2) CREAR OBJETOS Y GUARDARLOS EN UNA LISTA")
          ...
          if opcion == 1:
             os.system('cls');crear_base_datos();os.system('pause')
          if opcion == 2:
             os.system('cls');crear_lista_objetos();os.system('pause')
          elif opcion == 3:
             os.system('cls');mostrar_lista_objetos();os.system('pause') 
          elif opcion == 4:
             os.system('cls');anadir_objetos_basedatos();os.system('pause')
          elif opcion == 5:
             os.system('cls'); break 

def obtener_conexion():
    nra = "C:\\TRABAJANDO_PYTHON\\poo\\seleccionfutbol.sqlite3"
    conexion = None
    try:
...
def crear_base_datos():
    ...
    if conexion != None:
       ...
       try:
           ...
           print("ERROR: CREAR BASE DE DATOS")
    else:
...
def crear_lista_objetos():
    global seleccionfutbol_lo # GLOBAL para indicar modificar la variable
    seleccionfutbol_lo.clear()
    seleccionfutbol_lo = obtener_lista_seleccionfutbol_objeto()

  
def anadir_objetos_basedatos():
...
def mostrar_lista_objetos():
    for seleccionfutbol_o in seleccionfutbol_lo:
        print(seleccionfutbol_o.id_seleccionfutbol, seleccionfutbol_o.nombre, end=' ')
