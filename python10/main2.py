import sys
from PySide6.QtWidgets import QVBoxLayout, QApplication, QMainWindow, QWidget, QGridLayout, QLabel, QLineEdit, QPushButton
...
layout = QVBoxLayout() # GESTIONA DE FORMA VERTICAL 
